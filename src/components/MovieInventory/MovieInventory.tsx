...
export const MovieInventory = withRouter((props: MovieInventoryProps) => {
    console.log(props);
    const { history } = props;
        ...
        <div className={`${classes.root} ${classes.column}`}>
            ...
            <AppBar position="fixed" className={clsx(classes.appBar, { [classes.appBarShift]: open })}> {/* We are using MUI to make another navbar */}
                <Toolbar className={classes.toolbar}>
                    ...
                    <Button className={classes.toolbar_button} onClick={handleDialogClickOpen}>Create New Movie</Button>
